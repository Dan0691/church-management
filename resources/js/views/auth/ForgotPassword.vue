          ...
          <v-col cols="12" xl="5" lg="6" md="7" sm="10">
            <v-card class="auth-card elevation-10 rounded-lg">
              <div class="auth-header">
                ...
                <h1 class="text-h4 font-weight-bold gradient-text">Reset Password</h1>
                <p class="text-subtitle-1 text-medium-emphasis">Enter your email to receive reset link</p>
              </div>
              ...
              <v-card-text class="px-8 pb-8 pt-2">
                <v-form @submit.prevent="submit" ref="form">
                  ...
                  <v-btn
                    ...
                    height="52"
                  >
                    <span class="text-button font-weight-bold">Send Reset Link</span>
                  </v-btn>
...
const submit = async () => {
  ...
  try {
    ...
    if (result.success) {
      message.value = result.message || 'Password reset link sent to your email'
